...
def flatten_detail(single_detail, order_id):
	...
	for key, val in single_detail:

		if key in order_details_header:

			details_data[key] = val

		# STEPS FOR ORDER DETAILS
		# need to get nested again... or maybe sub on top of this.
		# bring in the id key to this other hash: details_data['summary_id'] = summary_data['id']
		details_data['summary_id'] = summary_data['id']
